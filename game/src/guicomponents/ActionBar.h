    ...
    virtual void update(const phantom::Time& time) {
        ...
        if(visible) {
            ...
            getGraphics().beginPath().setFillStyle(phantom::Colors::WHITE)
                .image("images/hud menu/menu bg.png", loc[0], loc[1], 761.0f, 163.0f).stroke()
                .image("images/hud menu/menu 1.png", loc[0] + 10.0f, loc[1] + 10.0f, 209.0f, 68.0f).stroke()
                .image("images/hud menu/menu 2.png", loc[0] + 225.0f, loc[1] + 10.0f, 209.0f, 68.0f).stroke()
                .image("images/hud menu/menu 3.png", loc[0] + 10.0f, loc[1] + 85.0f, 209.0f, 68.0f).stroke()
                .image("images/hud menu/menu 4.png", loc[0] + 225.0f, loc[1] + 85.0f, 209.0f, 68.0f).stroke()
