...
${OBJECTDIR}/_ext/1147955449/md5.o: ../libyaxl/libyaxl/file/md5.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1147955449/md5.o ../libyaxl/libyaxl/file/md5.cpp

${OBJECTDIR}/_ext/900185589/Socket.o: ../libyaxl/libyaxl/sockets/Socket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/900185589
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/900185589/Socket.o ../libyaxl/libyaxl/sockets/Socket.cpp

${OBJECTDIR}/_ext/1147955449/AbstractFile.o: ../libyaxl/libyaxl/file/AbstractFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1147955449
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1147955449/AbstractFile.o ../libyaxl/libyaxl/file/AbstractFile.cpp
...
${OBJECTDIR}/_ext/1682609240/Thread.o: ../libyaxl/libyaxl/concurrency/Thread.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1682609240/Thread.o ../libyaxl/libyaxl/concurrency/Thread.cpp

${OBJECTDIR}/_ext/900185589/InputStream.o: ../libyaxl/libyaxl/sockets/InputStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/900185589
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/900185589/InputStream.o ../libyaxl/libyaxl/sockets/InputStream.cpp

${OBJECTDIR}/_ext/1446051756/examples.o: ../libyaxl/libyaxl/examples/examples.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1446051756
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1446051756/examples.o ../libyaxl/libyaxl/examples/examples.cpp

${OBJECTDIR}/_ext/1147955449/WinFileImpl.o: ../libyaxl/libyaxl/file/WinFileImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1147955449
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1147955449/WinFileImpl.o ../libyaxl/libyaxl/file/WinFileImpl.cpp

${OBJECTDIR}/_ext/1147955449/PosixFileImpl.o: ../libyaxl/libyaxl/file/PosixFileImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1147955449
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I/usr/local/include -I../phantom/src -I../phantom/include -I. -I../libyaxl/libyaxl -I../sharedlib/src -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1147955449/PosixFileImpl.o ../libyaxl/libyaxl/file/PosixFileImpl.cpp
